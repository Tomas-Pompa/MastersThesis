...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-3-1.png" alt="Znázornění dvou funkcí na intervalu $[0, 1]$, ze kterých generujeme pozorování ze tříd 0 a 1." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-6-1.png" alt="Prvních 10 vygenerovaných pozorování z každé ze dvou klasifikačních tříd. Pozorovaná data nejsou vyhlazená." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-9-1.png" alt="Průběh $GCV(\lambda)$ pro zvolený vektor $\boldsymbol\lambda$. Na ose $x$ jsou hodnoty vyneseny v logaritmické škále. Červeně je znázorněna optimální hodnota vyhlazovacího parametru $\lambda_{optimal}$." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-10-1.png" alt="Prvních 10 vyhlazených křivek z každé klasifikační třídy." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-11-1.png" alt="Vykreslení všech vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Černou čerchovanou čarou je zakreslen průměr pro každou třídu." width="672" />
...
## 0.5214 0.4643 0.5786 0.5714 0.5071 0.5571 0.5214 0.6143 0.5643 0.5786 0.6000 
##     12 
## 0.5571 
## 
## -Optimal number of neighbors: knn.opt= 8 
## with highest probability of correct classification max.prob=  0.6142857 
## 
## -Probability of correct classification:  0.6143
```
...
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-16-1.png" width="672" />
...
```
##  [1] 0.5584993 0.5089899 0.5458586 0.5209091 0.5431746 0.5862771 0.5281962
##  [8] 0.5942569 0.5872872 0.5893506 0.5703608 0.5600577 0.6027850 0.5705628
## [15] 0.5823088 0.5558730 0.5848629 0.5375180 0.5398413 0.5223377 0.5169408
## [22] 0.5290043 0.5631169 0.5244589
```

Vidíme, že nejlépe vychází hodnota parametru $K$ jako 13 s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6028.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-18-1.png" alt="Závislost validační chybovosti na hodnotě $K$, tedy na počtu sousedů." width="672" />
...
## 0.6 
## 
## -Optimal number of neighbors: knn.opt= 13 
## with highest probability of correct classification max.prob=  0.6 
## 
## -Probability of correct classification:  0.6
```
...
Vidíme tedy, že přesnost modelu sestrojeného pomocí metody $K$ nejbližších sousedů s optimální volbou $K_{optimal}$ rovnou 13, kterou jsme určili cross-validací, je na trénovacích datech rovna 0.4 a na testovacích datech 0.55.
...
V tomto konkrétním případě jsme za počet hlavních komponent vzali $p$ = 2, které dohromady vysvětlují 99.88 % variability v datech.
První hlavní komponenta potom vysvětluje 99.43 % a druhá 0.44 % variability.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-22-1.png" alt="Hodnoty skórů prvních dvou hlavních komponent pro trénovací data. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
...
Spočítali jsme jednak přesnost klasifikátoru na trénovacích (62.86 %), tak i na testovacích datech (71.67 %).
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-25-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí LDA." width="672" />
...
Spočítali jsme tedy jednak přesnost klasifikátoru na trénovacích (62.14 %), tak i na testovacích datech (71.67 %).
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-31-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (parabola v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí QDA." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-35-1.png" alt="Závislost testovací a trénovací chybovosti na počtu bázových funkcí pro $\beta$. Červeným bodem je znázorněn optimální počet $n_{optimal}$ zvolený jako minimum testovací chybovosti, černou čarou je vykreslena testovací a modrou přerušovanou čarou je vykreslen průběh trénovací chybovosti." width="672" />
...
```
##         4         5         6         7         8         9        10        11 
## 0.7159811 0.6968902 0.6968902 0.6891979 0.6946524 0.6977993 0.6864624 0.6819169 
##        12        13        14        15        16        17        18        19 
## 0.6890598 0.6684803 0.6665323 0.6917953 0.6813675 0.6598172 0.6521249 0.6580073 
##        20        21        22        23        24        25 
## 0.6580073 0.6710777 0.6422466 0.6598172 0.6592678 0.6539349
```

Vykresleme si ještě průběh validační chybovosti i se zvýrazněnou optimální hodnotou $n_{optimal}$ rovnou 4 s validační chybovostí 0.284.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-38-1.png" alt="Závislost validační chybovosti na hodnotě $n_{basis}$, tedy na počtu bází." width="672" />
...
Spočítali jsme trénovací chybovost (rovna 23.57 %) i testovací chybovost (rovna 18.33 %).
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-40-1.png" alt="Závoslost odhadnutých pravděpodobností na hodnotách lineárního prediktoru. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-41-1.png" alt="Průběh odhadu parametrické funkce $\beta(t), t \in [0, 1]$." width="672" />
...
Spočítali jsme tedy přesnost klasifikátoru na trénovacích (63.57 %) i na testovacích datech (71.67 %).
...
Přesnost klasifikátoru na testovacích datech je tedy 51.67 % a na trénovacích datech 70.71 %.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-52-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-53-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost rozhodovacího stromu na testovacích datech je tedy 71.67 % a na trénovacích datech 66.43 %.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-56-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu sestrojeného na skórech hlavních komponent. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-57-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost rozhodovacího stromu na trénovacích datech je tedy 70.71 % a na testovacích datech 51.67 %.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-61-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu sestrojeného na bázových koeficientech. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-62-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost náhodného lesu na trénovacích datech je tedy 94.29 % a na testovacích datech 66.67 %.
...
Přesnost rozhodovacího stromu na trénovacích datech je tedy 97.14 % a na testovacích datech 58.33 %.
...
Přesnost tohoto klasifikátoru na trénovacích datech je 93.57 % a na testovacích datech 65 %.
...
Přesnost metody SVM na trénovacích datech je tedy 76.43 % pro lineární jádro, 59.29 % pro polynomiální jádro a 55.71 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 83.33 % pro lineární jádro, 73.33 % pro polynomiální jádro a 51.67 % pro radiální jádro.
...
Přesnost metody SVM aplikované na skóre hlavních komponent na trénovacích datech je tedy 61.43 % pro lineární jádro, 64.29 % pro polynomiální jádro a 66.43 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 75 % pro lineární jádro, 71.67 % pro polynomiální jádro a 68.33 % pro radiální jádro.
...
Přesnost metody SVM aplikované na bázové koeficienty na trénovacích datech je tedy 75.71 % pro lineární jádro, 64.29 % pro polynomiální jádro a 57.14 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 83.33 % pro lineární jádro, 75 % pro polynomiální jádro a 51.67 % pro radiální jádro.
...
Vidíme, že nejlépe vychází hodnota parametru $d$ jako 8 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7422, 4 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6698 a 5 pro radiální jádro s hodnotou přesnosti 0.6736.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-82-1.png" alt="Závislost validační chybovosti na dimenzi podprostoru $V_d$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM. Černými body jsou vyznačeny optimální hodnoty dimenze $V_d$ pro jednotlivé jádrové funkce." width="672" />
...
Přesnost metody SVM aplikované na bázové koeficienty na trénovacích datech je tedy 23.57 % pro lineární jádro, 32.86 % pro polynomiální jádro a 27.86 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 25 % pro lineární jádro, 30 % pro polynomiální jádro a 40 % pro radiální jádro.
...
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS                                                                    0.1714                                                   0.3333
SVM poly - RKHS                                                                      0.1286                                                   0.3500
SVM rbf - RKHS                                                                       0.1500                                                   0.3667
...
-------  ------------------------------  ----------------------------------  ----------------------------------  ----------------------------------
linear                               35                              0.1179                              0.2706  linear                            
poly                                 14                              0.1179                              0.2497  polynomial                        
radial                               15                             10.0000                              0.2707  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 35 a $\gamma={}$ 0.1179 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7294, $d={}$ 14 a $\gamma={}$ 0.1179 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7503 a $d={}$ 15 a $\gamma={}$ 10 pro radiální jádro s hodnotou přesnosti 0.7293.
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-94-1.png" alt="Závislost validační chybovosti na volbě hyperparametrů $d$ a $\gamma$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM." width="672" />
...
Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - radial                                                           0.2357                                                   0.3167
SVM poly - RKHS - radial                                                             0.2357                                                   0.3667
SVM rbf - RKHS - radial                                                              0.2500                                                   0.3500

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 23.57 % pro lineární jádro, 23.57 % pro polynomiální jádro a 25 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 31.67 % pro lineární jádro, 36.67 % pro polynomiální jádro a 35 % pro radiální jádro.
...
-------  ------------------------------  ------------------------------  ----------------------------------  ----------------------------------
linear                               14                               5                              0.2746  linear                            
poly                                 14                               5                              0.2746  polynomial                        
radial                                7                               5                              0.2746  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 14 a $p={}$ 5 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7254, $d={}$ 14 a $p={}$ 5 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7254 a $d={}$ 7 a $p={}$ 5 pro radiální jádro s hodnotou přesnosti 0.7254.
...
Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - poly                                                             0.2786                                                   0.4167
SVM poly - RKHS - poly                                                               0.2786                                                   0.3833
SVM rbf - RKHS - poly                                                                0.2786                                                   0.4000

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 27.86 % pro lineární jádro, 27.86 % pro polynomiální jádro a 27.86 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 41.67 % pro lineární jádro, 38.33 % pro polynomiální jádro a 40 % pro radiální jádro.
...
-------  ------------------------------  ----------------------------------  ----------------------------------
linear                                3                              0.3507  linear                            
poly                                  5                              0.3719  polynomial                        
radial                               11                              0.3503  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 3 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6493, $d={}$ 5 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6281 a $d={}$ 11 pro radiální jádro s hodnotou přesnosti 0.6497.
...
Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - linear                                                           0.3429                                                   0.2667
SVM poly - RKHS - linear                                                             0.3214                                                   0.3667
SVM rbf - RKHS - linear                                                              0.2929                                                   0.3167

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 34.29 % pro lineární jádro, 32.14 % pro polynomiální jádro a 29.29 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 26.67 % pro lineární jádro, 36.67 % pro polynomiální jádro a 31.67 % pro radiální jádro.
...
LDA                                                                                  0.3714                                                   0.2833
QDA                                                                                  0.3786                                                   0.2833
LR functional                                                                        0.2357                                                   0.1833
LR score                                                                             0.3643                                                   0.2833
Tree - diskr.                                                                        0.2929                                                   0.4833
Tree - score                                                                         0.3357                                                   0.2833
Tree - Bbasis                                                                        0.2929                                                   0.4833
RForest - diskr                                                                      0.0571                                                   0.3333
RForest - score                                                                      0.0286                                                   0.4167
RForest - Bbasis                                                                     0.0643                                                   0.3500
SVM linear - diskr                                                                   0.2357                                                   0.1667
SVM poly - diskr                                                                     0.4071                                                   0.2667
SVM rbf - diskr                                                                      0.4429                                                   0.4833
SVM linear - PCA                                                                     0.3857                                                   0.2500
SVM poly - PCA                                                                       0.3571                                                   0.2833
SVM rbf - PCA                                                                        0.3357                                                   0.3167
SVM linear - Bbasis                                                                  0.2429                                                   0.1667
SVM poly - Bbasis                                                                    0.3571                                                   0.2500
SVM rbf - Bbasis                                                                     0.4286                                                   0.4833
SVM linear - projection                                                              0.2357                                                   0.2500
SVM poly - projection                                                                0.3286                                                   0.3000
SVM rbf - projection                                                                 0.2786                                                   0.4000
SVM linear - RKHS - radial                                                           0.2357                                                   0.3167
SVM poly - RKHS - radial                                                             0.2357                                                   0.3667
SVM rbf - RKHS - radial                                                              0.2500                                                   0.3500
SVM linear - RKHS - poly                                                             0.2786                                                   0.4167
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-120-1.png" alt="Krabicové diagramy trénovacích chybovostí pro 100 simulací zvlášť pro jednotlivé klasifikační metody. Černými symboly $+$ jsou vyznačeny průměry." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-122-1.png" alt="Krabicové diagramy testovacích chybovostí pro 100 simulací zvlášť pro jednotlivé klasifikační metody. Černými symboly $+$ jsou vyznačeny průměry." width="672" />
...
<div class="figure">
<img src="04-Simulace_4_files/figure-html/unnamed-chunk-125-1.png" alt="Krabicové diagramy hodnot hyperparametrů." width="672" />
