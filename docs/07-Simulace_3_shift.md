...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-3-1.png" alt="Body, kterými definujeme interpolační polynomy." width="672" />
<p class="caption">(\#fig:unnamed-chunk-3)Body, kterými definujeme interpolační polynomy.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-7-1.png" alt="Znázornění dvou funkcí na intervalu $I = [0, 6]$, ze kterých generujeme pozorování ze tříd 0 a 1." width="672" />
<p class="caption">(\#fig:unnamed-chunk-7)Znázornění dvou funkcí na intervalu $I = [0, 6]$, ze kterých generujeme pozorování ze tříd 0 a 1.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-12-1.png" alt="Prvních 10 vygenerovaných pozorování z každé ze dvou klasifikačních tříd. Pozorovaná data nejsou vyhlazená." width="672" />
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-15-1.png" alt="Průběh $GCV(\lambda)$ pro zvolený vektor $\boldsymbol\lambda$. Na ose $x$ jsou hodnoty vyneseny v logaritmické škále. Červeně je znázorněna optimální hodnota vyhlazovacího parametru $\lambda_{optimal}$." width="672" />
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-16-1.png" alt="Prvních 10 vyhlazených křivek z každé klasifikační třídy." width="672" />
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-17-1.png" alt="Vykreslení všech vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Tlustou čarou je zakreslen průměr pro každou třídu." width="672" />
<p class="caption">(\#fig:unnamed-chunk-17)Vykreslení všech vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Tlustou čarou je zakreslen průměr pro každou třídu.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-18-1.png" alt="Vykreslení všech vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Tlustou čarou je zakreslen průměr pro každou třídu. Přiblížený pohled." width="672" />
<p class="caption">(\#fig:unnamed-chunk-18)Vykreslení všech vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Tlustou čarou je zakreslen průměr pro každou třídu. Přiblížený pohled.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-25-1.png" alt="Závislost validační chybovosti na hodnotě $K$, tedy na počtu sousedů." width="672" />
<p class="caption">(\#fig:unnamed-chunk-25)Závislost validační chybovosti na hodnotě $K$, tedy na počtu sousedů.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-29-1.png" alt="Hodnoty skórů prvních dvou hlavních komponent pro trénovací data. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
<p class="caption">(\#fig:unnamed-chunk-29)Hodnoty skórů prvních dvou hlavních komponent pro trénovací data. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-32-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí LDA." width="672" />
<p class="caption">(\#fig:unnamed-chunk-32)Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí LDA.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-38-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (parabola v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí QDA." width="672" />
<p class="caption">(\#fig:unnamed-chunk-38)Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (parabola v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí QDA.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-42-1.png" alt="Závislost testovací a trénovací chybovosti na počtu bázových funkcí pro $\beta$. Červeným bodem je znázorněn optimální počet $n_{optimal}$ zvolený jako minimum testovací chybovosti, černou čarou je vykreslena testovací a modrou přerušovanou čarou je vykreslen průběh trénovací chybovosti." width="672" />
<p class="caption">(\#fig:unnamed-chunk-42)Závislost testovací a trénovací chybovosti na počtu bázových funkcí pro $\beta$. Červeným bodem je znázorněn optimální počet $n_{optimal}$ zvolený jako minimum testovací chybovosti, černou čarou je vykreslena testovací a modrou přerušovanou čarou je vykreslen průběh trénovací chybovosti.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-45-1.png" alt="Závislost validační chybovosti na hodnotě $n_{basis}$, tedy na počtu bází." width="672" />
<p class="caption">(\#fig:unnamed-chunk-45)Závislost validační chybovosti na hodnotě $n_{basis}$, tedy na počtu bází.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-47-1.png" alt="Závislost odhadnutých pravděpodobností na hodnotách lineárního prediktoru. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
<p class="caption">(\#fig:unnamed-chunk-47)Závislost odhadnutých pravděpodobností na hodnotách lineárního prediktoru. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-48-1.png" alt="Průběh odhadu parametrické funkce $\beta(t), t \in [0, 6]$." width="672" />
<p class="caption">(\#fig:unnamed-chunk-48)Průběh odhadu parametrické funkce $\beta(t), t \in [0, 6]$.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-58-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka, resp. křivky v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí metody SVM." width="672" />
<p class="caption">(\#fig:unnamed-chunk-58)Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka, resp. křivky v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí metody SVM.</p>
</div>
...
Vidíme, že nejlépe vychází hodnota parametru $d$ jako 11 pro lineární jádro s hodnotou chybovosti spočtenou pomocí 10-násobné CV 0.0558, 11 pro polynomiální jádro s hodnotou spočtenou pomocí 10-násobné CV 0.0767 a 10 pro radiální jádro s hodnotou 0.0696.
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-63-1.png" alt="Závislost validační chybovosti na dimenzi podprostoru $V_d$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM. Černými body jsou vyznačeny optimální hodnoty dimenze $V_d$ pro jednotlivé jádrové funkce." width="672" />
<p class="caption">(\#fig:unnamed-chunk-63)Závislost validační chybovosti na dimenzi podprostoru $V_d$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM. Černými body jsou vyznačeny optimální hodnoty dimenze $V_d$ pro jednotlivé jádrové funkce.</p>
</div>
...
Table: (\#tab:unnamed-chunk-71)Souhrnné výsledky metody SVM v kombinaci s RKHS na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.
...
Table: (\#tab:unnamed-chunk-74)Souhrnné výsledky cross-validace pro metodu SVM v kombinaci s RKHS na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-75-1.png" alt="Závislost validační chybovosti na volbě hyperparametrů $d$ a $\gamma$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM." width="672" />
<p class="caption">(\#fig:unnamed-chunk-75)Závislost validační chybovosti na volbě hyperparametrů $d$ a $\gamma$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM.</p>
</div>
...
Chybovost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 2.14 % pro lineární jádro, 0 % pro polynomiální jádro a 2.14 % pro gaussovské jádro.
Na testovacích datech je potom chybovost metody 18.33 % pro lineární jádro, 20 % pro polynomiální jádro a 16.67 % pro radiální jádro.
...
Table: (\#tab:unnamed-chunk-80)Souhrnné výsledky použitých metod na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-84-1.png" alt="Graf závislosti trénovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{shift}$, který definuje směrodatnou odchylku pro generování náhodného vertikálního posunu." width="672" />
<p class="caption">(\#fig:unnamed-chunk-84)Graf závislosti trénovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{shift}$, který definuje směrodatnou odchylku pro generování náhodného vertikálního posunu.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-85-1.png" alt="Graf závislosti testovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{shift}$, který definuje směrodatnou odchylku pro generování náhodných vertikálních posunutí." width="672" />
<p class="caption">(\#fig:unnamed-chunk-85)Graf závislosti testovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{shift}$, který definuje směrodatnou odchylku pro generování náhodných vertikálních posunutí.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-88-1.png" alt="Graf závislosti testovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{x}$." width="672" />
<p class="caption">(\#fig:unnamed-chunk-88)Graf závislosti testovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{x}$.</p>
</div>
...
<div class="figure">
<img src="07-Simulace_3_shift_files/figure-html/unnamed-chunk-90-1.png" alt="Graf závislosti testovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{x}$." width="672" />
<p class="caption">(\#fig:unnamed-chunk-90)Graf závislosti testovací chybovosti pro jednotlivé klasifikační metody na hodnotě parametru $\sigma_{x}$.</p>
</div>

```r
# ggsave("figures/kap6_sim_03shift_curvesErr.tex", device = tikz, width = 8, height = 4)
```
