...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-5-1.png" alt="Log-periodogramy fonémů pro vybrané záznamy." width="1920" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-9-1.png" alt="Průběh $GCV(\lambda)$ pro zvolený vektor $\boldsymbol\lambda$. Na ose $x$ jsou hodnoty vyneseny v logaritmické škále. Červeně je znázorněna optimální hodnota vyhlazovacího parametru $\lambda_{optimal}$." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-12-1.png" alt="Log-periodogramy fonémů pro vybrané záznamy." width="960" />
...
<img src="10-Application_2_files/figure-html/unnamed-chunk-17-1.png" width="672" />
...
Vidíme, že nejlépe vychází hodnota parametru $K$ jako 22 s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.798.
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-19-1.png" alt="Závislost validační chybovosti na hodnotě $K$, tedy na počtu sousedů." width="672" />
...
Vidíme tedy, že přesnost modelu sestrojeného pomocí metody $K$ nejbližších sousedů s optimální volbou $K_{optimal}$ rovnou 22, kterou jsme určili cross-validací, je na trénovacích datech rovna 0.1987 a na testovacích datech 0.2073.
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-23-1.png" alt="Hodnoty skórů prvních dvou hlavních komponent pro trénovací data. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
...
Spočítali jsme jednak přesnost klasifikátoru na trénovacích (80.05 %), tak i na testovacích datech (79.04 %).
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-26-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí LDA." width="672" />
...
Spočítali jsme tedy jednak přesnost klasifikátoru na trénovacích (79.81 %), tak i na testovacích datech (79.04 %).
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-32-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (parabola v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí QDA." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-36-1.png" alt="Závislost testovací a trénovací chybovosti na počtu bázových funkcí pro $\beta$. Červeným bodem je znázorněn optimální počet $n_{optimal}$ zvolený jako minimum testovací chybovosti, černou čarou je vykreslena testovací a modrou přerušovanou čarou je vykreslen průběh trénovací chybovosti." width="672" />
...
Naopak optimální volbou na základě testovací chybovosti je $n$ rovno 14, tedy výrazně menší hodnota než 50.
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-39-1.png" alt="Závislost validační chybovosti na hodnotě $n_{basis}$, tedy na počtu bází." width="672" />
...
Spočítali jsme tedy přesnost klasifikátoru na trénovacích (79.97 %) i na testovacích datech (78.82 %).
...
Přesnost klasifikátoru na testovacích datech je tedy 78.59 % a na trénovacích datech 82.24 %.
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-52-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-53-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost rozhodovacího stromu na testovacích datech je tedy 68.79 % a na trénovacích datech 74.73 %.
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-56-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu sestrojeného na skórech hlavních komponent. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-57-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost rozhodovacího stromu na trénovacích datech je tedy 84.12 % a na testovacích datech 77.9 %.
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-61-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu sestrojeného na bázových koeficientech. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-62-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-79-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka, resp. křivky v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí metody SVM." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-86-1.png" alt="Závislost validační chybovosti na dimenzi podprostoru $V_d$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM. Černými body jsou vyznačeny optimální hodnoty dimenze $V_d$ pro jednotlivé jádrové funkce." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-99-1.png" alt="Závislost validační chybovosti na volbě hyperparametrů $d$ a $\gamma$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM." width="672" />
...
Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 17.84 % pro lineární jádro, 6.96 % pro polynomiální jádro a 12.91 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 22.55 % pro lineární jádro, 23.46 % pro polynomiální jádro a 22.55 % pro radiální jádro.
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-124-1.png" alt="Průběh $GCV(\lambda)$ pro zvolený vektor $\boldsymbol\lambda$. Na ose $x$ jsou hodnoty vyneseny v logaritmické škále. Červeně je znázorněna optimální hodnota vyhlazovacího parametru $\lambda_{optimal}$." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-126-1.png" alt="Vykreslení prvních 100 vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Černou čarou je zakreslen průměr pro každou třídu." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-127-1.png" alt="Log-periodogramy fonémů pro vybrané záznamy." width="960" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-131-1.png" alt="Hodnoty skórů prvních dvou hlavních komponent pro trénovací data. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
...
Spočítali jsme jednak přesnost klasifikátoru na trénovacích (100 %), tak i na testovacích datech (99.78 %).
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-134-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí LDA." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-138-1.png" alt="Závislost testovací a trénovací chybovosti na počtu bázových funkcí pro $\beta$. Červeným bodem je znázorněn optimální počet $n_{optimal}$ zvolený jako minimum testovací chybovosti, černou čarou je vykreslena testovací a modrou přerušovanou čarou je vykreslen průběh trénovací chybovosti." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-141-1.png" alt="Závislost validační chybovosti na hodnotě $n_{basis}$, tedy na počtu bází." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-143-1.png" alt="Závoslost odhadnutých pravděpodobností na hodnotách lineárního prediktoru. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-144-1.png" alt="Průběh odhadu parametrické funkce $\beta(t), t \in [1, 256]$." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-150-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka, resp. křivky v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí metody SVM." width="672" />
...
<div class="figure">
<img src="10-Application_2_files/figure-html/unnamed-chunk-156-1.png" alt="Závislost validační chybovosti na dimenzi podprostoru $V_d$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM. Černými body jsou vyznačeny optimální hodnoty dimenze $V_d$ pro jednotlivé jádrové funkce." width="672" />
