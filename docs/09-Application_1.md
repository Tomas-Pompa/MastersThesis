...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-2-1.png" alt="Růstové křivky zlášť pro dívky a chlapce." width="672" />
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-5-1.png" alt="Průběh $GCV(\lambda)$ pro zvolený vektor $\boldsymbol\lambda$. Na ose $x$ jsou hodnoty vyneseny v logaritmické škále při základu 10. Červeně je znázorněna optimální hodnota vyhlazovacího parametru $\lambda_{optimal}$." width="672" />
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-7-1.png" alt="Vykreslení všech vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle pohlaví. Černou čerchovanou čarou je zakreslen průměr pro každou třídu." width="672" />
...
set.seed(42)
split <- sample.split(XXfd$fdnames$reps, SplitRatio = 0.65)
...
## CV 0.8828571 0.8357143 0.9221429 0.8904762 0.9221429 0.9214286 0.9221429
##         [,8]      [,9]      [,10]      [,11]      [,12]      [,13]      [,14]
## K  8.0000000 9.0000000 10.0000000 11.0000000 12.0000000 13.0000000 14.0000000
## CV 0.9214286 0.9071429  0.9321429  0.9321429  0.9464286  0.9214286  0.9321429
##         [,15]      [,16]
## K  15.0000000 16.0000000
## CV  0.9178571  0.9178571
```

Vidíme, že nejlépe vychází hodnota parametru $K$ jako 12 s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9464.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-14-1.png" alt="Závislost validační chybovosti na hodnotě $K$, tedy na počtu sousedů." width="672" />
...
Vidíme tedy, že přesnost modelu sestrojeného pomocí metody $K$ nejbližších sousedů s optimální volbou $K_{optimal}$ rovnou 12, kterou jsme určili cross-validací, je na trénovacích datech rovna 0.05 a na testovacích datech 0.0303.
...
V tomto konkrétním případě jsme za počet hlavních komponent vzali $p=$ 2, které dohromady vysvětlují 94.91 $\%$ variability v datech.
První hlavní komponenta potom vysvětluje 81.49 % a druhá 13.42 $\%$ variability.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-18-1.png" alt="Hodnoty skórů prvních dvou hlavních komponent pro trénovací data. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
...
Spočítali jsme jednak přesnost klasifikátoru na trénovacích (98.33 %), tak i na testovacích datech (96.97 %).
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-21-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle pohlaví. Černě je vyznačena dělící hranice (přímka v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí LDA." width="672" />
...
Spočítali jsme tedy jednak přesnost klasifikátoru na trénovacích (98.33 %), tak i na testovacích datech (96.97 %).
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-27-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle pohlaví. Černě je vyznačena dělící hranice (parabola v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí QDA." width="672" />
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-31-1.png" alt="Závislost testovací a trénovací chybovosti na počtu bázových funkcí pro $\beta$. Červeným bodem je znázorněn optimální počet $n_{optimal}$ zvolený jako minimum testovací chybovosti, černou čarou je vykreslena testovací a modrou přerušovanou čarou je vykreslen průběh trénovací chybovosti." width="672" />
...
Vykresleme si ještě průběh validační chybovosti i se zvýrazněnou optimální hodnotou $n_{optimal}$ rovnou 17 s validační chybovostí 0.154.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-34-1.png" alt="Závislost validační chybovosti na hodnotě $n_{basis}$, tedy na počtu bází." width="672" />
<p class="caption">(\#fig:unnamed-chunk-34)Závislost validační chybovosti na hodnotě $n_{basis}$, tedy na počtu bází.</p>
</div>

Nyní již tedy můžeme definovat finální model pomocí funkcionální logistické regrese, přičemž bázi pro $\beta(t)$ volíme B-splinovou bázi s 17 bázemi.
...
Spočítali jsme trénovací chybovost (rovna 0 %) i testovací chybovost (rovna 24.24 %).
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-36-1.png" alt="Závoslost odhadnutých pravděpodobností na hodnotách lineárního prediktoru. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="672" />
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-37-1.png" alt="Průběh odhadu parametrické funkce $\beta(t), t \in [0, 6]$." width="672" />
<p class="caption">(\#fig:unnamed-chunk-37)Průběh odhadu parametrické funkce $\beta(t), t \in [0, 6]$.</p>
</div>

Vidíme, že hodnoty funkce $\hat\beta(t)$ se drží kolem nuly pro časy $t$ z prostředka  a začátku intervalu $[1, 18]$, zatímco pro pozdějsí časy jsou hodnoty vyšší.
...
Spočítali jsme tedy přesnost klasifikátoru na trénovacích (98.33 %) i na testovacích datech (96.97 %).
...
Přesnost klasifikátoru na testovacích datech je tedy 90.91 % a na trénovacích datech 88.33 %.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-47-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-48-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost rozhodovacího stromu na testovacích datech je tedy 87.88 % a na trénovacích datech 90 %.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-51-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu sestrojeného na skórech hlavních komponent. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
<p class="caption">(\#fig:unnamed-chunk-51)Grafické znázornění neprořezaného rozhodovacího stromu sestrojeného na skórech hlavních komponent. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0.</p>
</div>
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-52-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost rozhodovacího stromu na trénovacích datech je tedy 88.33 % a na testovacích datech 90.91 %.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-56-1.png" alt="Grafické znázornění neprořezaného rozhodovacího stromu sestrojeného na bázových koeficientech. Modrými odstíny jsou vykresleny uzly příslušející klasifikační třídě 1 a červenými odstíny třídě 0." width="672" />
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-57-1.png" alt="Finální prořezaný rozhodovací strom." width="672" />
...
Přesnost náhodného lesu na trénovacích datech je tedy 96.67 % a na testovacích datech 93.94 %.
...
Přesnost rozhodovacího stromu na trénovacích datech je tedy 98.33 % a na testovacích datech 93.94 %.
...
Přesnost tohoto klasifikátoru na trénovacích datech je 98.33 % a na testovacích datech 93.94 %.
...
Přesnost metody SVM na trénovacích datech je tedy 98.33 % pro lineární jádro, 76.67 % pro polynomiální jádro a 96.67 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 96.97 % pro lineární jádro, 72.73 % pro polynomiální jádro a 96.97 % pro radiální jádro.
...
#### Skóre hlavních komponent {#PCA-SVMA1}
...
Přesnost metody SVM aplikované na skóre hlavních komponent na trénovacích datech je tedy 98.33 % pro lineární jádro, 91.67 % pro polynomiální jádro a 98.33 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 96.97 % pro lineární jádro, 96.97 % pro polynomiální jádro a 96.97 % pro radiální jádro.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-72-1.png" alt="Skóre prvních dvou hlavních komponent, barevně odlišené podle příslušnosti do klasifikační třídy. Černě je vyznačena dělící hranice (přímka, resp. křivky v rovině prvních dvou hlavních komponent) mezi třídami sestrojená pomocí metody SVM." width="672" />
...
#### Bázové koeficienty {#basis-SVMA1}
...
Přesnost metody SVM aplikované na bázové koeficienty na trénovacích datech je tedy 98.33 % pro lineární jádro, 85 % pro polynomiální jádro a 98.33 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 96.97 % pro lineární jádro, 84.85 % pro polynomiální jádro a 96.97 % pro radiální jádro.
...
## linear     8 0.01250000
## poly       4 0.08107143
## radial    13 0.02916667
```

Vidíme, že nejlépe vychází hodnota parametru $d$ jako 8 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9875, 4 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9189 a 13 pro radiální jádro s hodnotou přesnosti 0.9708.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-77-1.png" alt="Závislost validační chybovosti na dimenzi podprostoru $V_d$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM. Černými body jsou vyznačeny optimální hodnoty dimenze $V_d$ pro jednotlivé jádrové funkce." width="672" />
...
Přesnost metody SVM aplikované na bázové koeficienty na trénovacích datech je tedy 1.67 % pro lineární jádro, 3.33 % pro polynomiální jádro a 1.67 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 3.03 % pro lineární jádro, 0 % pro polynomiální jádro a 3.03 % pro radiální jádro.
...
```r
# hodnoty z clanku 
# A. Muñoz, J. González / Pattern Recognition Letters 31 (2010) 511–516
eps <- 0.01
C <- 100
```
...
Table: (\#tab:unnamed-chunk-86)Souhrnné výsledky metody SVM v kombinaci s RKHS na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.

Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS                                                                    0.0000                                                   0.2121
SVM poly - RKHS                                                                      0.0333                                                   0.6364
SVM rbf - RKHS                                                                       0.0167                                                   0.1818
...
Table: (\#tab:unnamed-chunk-89)Souhrnné výsledky cross-validace pro metodu SVM v kombinaci s RKHS na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.

          $\quad\quad\quad\quad\quad d$   $\quad\quad\quad\quad\quad\gamma$   $\widehat{Err}_{cross\_validace}$  Model                             
-------  ------------------------------  ----------------------------------  ----------------------------------  ----------------------------------
linear                               15                            100.0000                              0.0595  linear                            
poly                                  3                              3.7276                              0.0619  polynomial                        
radial                               28                             51.7947                              0.0762  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 15 a $\gamma={}$ 100 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9405, $d={}$ 3 a $\gamma={}$ 3.7276 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9381 a $d={}$ 28 a $\gamma={}$ 51.7947 pro radiální jádro s hodnotou přesnosti 0.9238.
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-90-1.png" alt="Závislost validační chybovosti na volbě hyperparametrů $d$ a $\gamma$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM." width="672" />
<p class="caption">(\#fig:unnamed-chunk-90)Závislost validační chybovosti na volbě hyperparametrů $d$ a $\gamma$, zvlášť pro všechna tři uvažovaná jádra v metodě SVM.</p>
</div>
...
Table: (\#tab:unnamed-chunk-93)Souhrnné výsledky metody SVM v kombinaci s RKHS na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.

Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - radial                                                             0.05                                                   0.1212
SVM poly - RKHS - radial                                                               0.05                                                   0.0606
SVM rbf - RKHS - radial                                                                0.05                                                   0.1515

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 5 % pro lineární jádro, 5 % pro polynomiální jádro a 5 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 12.12 % pro lineární jádro, 6.06 % pro polynomiální jádro a 15.15 % pro radiální jádro.
...
-------  ------------------------------  ------------------------------  ----------------------------------  ----------------------------------
linear                               26                               3                              0.0795  linear                            
poly                                  6                               5                              0.0819  polynomial                        
radial                                2                               2                              0.0962  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 26 a $p={}$ 3 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9205, $d={}$ 6 a $p={}$ 5 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9181 a $d={}$ 2 a $p={}$ 2 pro radiální jádro s hodnotou přesnosti 0.9038.
...
Table: (\#tab:unnamed-chunk-101)Souhrnné výsledky metody SVM v kombinaci s RKHS na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.

Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - poly                                                             0.0167                                                   0.0909
SVM poly - RKHS - poly                                                               0.0333                                                   0.0606
SVM rbf - RKHS - poly                                                                0.0833                                                   0.0303

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 1.67 % pro lineární jádro, 3.33 % pro polynomiální jádro a 8.33 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 9.09 % pro lineární jádro, 6.06 % pro polynomiální jádro a 3.03 % pro radiální jádro.
...
-------  ------------------------------  ----------------------------------  ----------------------------------
linear                               19                              0.1043  linear                            
poly                                 19                              0.0843  polynomial                        
radial                                7                              0.1519  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 19 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.8957, $d={}$ 19 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.9157 a $d={}$ 7 pro radiální jádro s hodnotou přesnosti 0.8481.
...
Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - linear                                                           0.0667                                                   0.0909
SVM poly - RKHS - linear                                                             0.0000                                                   0.0303
SVM rbf - RKHS - linear                                                              0.0167                                                   0.2121

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 6.67 % pro lineární jádro, 0 % pro polynomiální jádro a 1.67 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 9.09 % pro lineární jádro, 3.03 % pro polynomiální jádro a 21.21 % pro radiální jádro.
...
Table: (\#tab:unnamed-chunk-111)Souhrnné výsledky použitých metod na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti a $\widehat{Err}_{test}$ testovací chybovosti.
...
LDA                                                                                  0.0167                                                   0.0303
QDA                                                                                  0.0167                                                   0.0303
LR functional                                                                        0.0000                                                   0.2424
LR score                                                                             0.0167                                                   0.0303
Tree - diskr.                                                                        0.1167                                                   0.0909
Tree - score                                                                         0.1000                                                   0.1212
Tree - Bbasis                                                                        0.1167                                                   0.0909
RForest - diskr                                                                      0.0333                                                   0.0606
RForest - score                                                                      0.0167                                                   0.0606
RForest - Bbasis                                                                     0.0167                                                   0.0606
SVM linear - diskr                                                                   0.0167                                                   0.0303
SVM poly - diskr                                                                     0.2333                                                   0.2727
SVM rbf - diskr                                                                      0.0333                                                   0.0303
SVM linear - PCA                                                                     0.0167                                                   0.0303
SVM poly - PCA                                                                       0.0833                                                   0.0303
SVM rbf - PCA                                                                        0.0167                                                   0.0303
SVM linear - Bbasis                                                                  0.0167                                                   0.0303
SVM poly - Bbasis                                                                    0.1500                                                   0.1515
SVM rbf - Bbasis                                                                     0.0167                                                   0.0303
SVM linear - projection                                                              0.0167                                                   0.0303
SVM poly - projection                                                                0.0333                                                   0.0000
SVM rbf - projection                                                                 0.0167                                                   0.0303
SVM linear - RKHS - radial                                                           0.0500                                                   0.1212
SVM poly - RKHS - radial                                                             0.0500                                                   0.0606
SVM rbf - RKHS - radial                                                              0.0500                                                   0.1515
SVM linear - RKHS - poly                                                             0.0167                                                   0.0909
SVM poly - RKHS - poly                                                               0.0333                                                   0.0606
SVM rbf - RKHS - poly                                                                0.0833                                                   0.0303
SVM linear - RKHS - linear                                                           0.0667                                                   0.0909
...
Nyní zopakujeme celou předchozí část 10-krát a hodnoty chybovostí si budeme ukládat to listu `SIMULACE`.
...
save(SIMULACE, CV_RESULTS, file = 'RData/aplikace_01.RData')
```
...
# ulozime vysledne hodnoty 
save(SIMULACE.df, file = 'RData/aplikace_01_res.RData')
```
...
Table: (\#tab:unnamed-chunk-116)Souhrnné výsledky použitých metod na simulovaných datech. $\widehat{Err}_{train}$ značí odhad trénovací chybovosti, $\widehat{Err}_{test}$ testovací chybovosti, $\widehat{SD}_{train}$ odhad směrodatné odchylky trénovacích chybovostí a $\widehat{SD}_{test}$ je odhad směrodatné odchylky testovacích chybovostí.

                              $\widehat{Err}_{train}$   $\widehat{Err}_{test}$   $\widehat{SD}_{train}$   $\widehat{SD}_{test}$
---------------------------  ------------------------  -----------------------  -----------------------  ----------------------
KNN                                            0.0633                   0.0545                   0.0246                  0.0344
LDA                                            0.0267                   0.0121                   0.0086                  0.0156
QDA                                            0.0383                   0.0152                   0.0158                  0.0214
LR_functional                                  0.0350                   0.0727                   0.0200                  0.0383
LR_score                                       0.0383                   0.0152                   0.0112                  0.0214
Tree_discr                                     0.1083                   0.1364                   0.0239                  0.0674
Tree_score                                     0.0800                   0.1485                   0.0367                  0.0579
Tree_Bbasis                                    0.1083                   0.1364                   0.0239                  0.0674
RF_discr                                       0.0200                   0.0879                   0.0131                  0.0614
RF_score                                       0.0233                   0.0455                   0.0141                  0.0410
RF_Bbasis                                      0.0183                   0.0818                   0.0095                  0.0590
SVM linear - diskr                             0.0300                   0.0333                   0.0131                  0.0265
SVM poly - diskr                               0.2200                   0.2636                   0.0367                  0.0881
SVM rbf - diskr                                0.0317                   0.0424                   0.0095                  0.0326
SVM linear - PCA                               0.0300                   0.0182                   0.0131                  0.0156
SVM poly - PCA                                 0.0733                   0.0667                   0.0196                  0.0424
SVM rbf - PCA                                  0.0283                   0.0121                   0.0112                  0.0156
SVM linear - Bbasis                            0.0267                   0.0212                   0.0086                  0.0205
SVM poly - Bbasis                              0.1783                   0.2091                   0.0561                  0.1035
SVM rbf - Bbasis                               0.0250                   0.0242                   0.0088                  0.0192
SVM linear - projection                        0.0300                   0.0273                   0.0131                  0.0224
SVM poly - projection                          0.0617                   0.0667                   0.0343                  0.0511
SVM rbf - projection                           0.0300                   0.0364                   0.0131                  0.0192
SVM linear - RKHS - radial                     0.0400                   0.1030                   0.0251                  0.0717
SVM poly - RKHS - radial                       0.0500                   0.0606                   0.0222                  0.0623
SVM rbf - RKHS - radial                        0.0433                   0.0848                   0.0161                  0.0636
SVM linear - RKHS - poly                       0.0767                   0.0848                   0.0211                  0.0682
SVM poly - RKHS - poly                         0.0350                   0.1030                   0.0266                  0.0499
SVM rbf - RKHS - poly                          0.0467                   0.1182                   0.0367                  0.0614
SVM linear - RKHS - linear                     0.0400                   0.1333                   0.0353                  0.0703
SVM poly - RKHS - linear                       0.0350                   0.1303                   0.0200                  0.0893
SVM rbf - RKHS - linear                        0.0350                   0.1000                   0.0200                  0.0554
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-117-1.png" alt="Krabicové diagramy trénovacích chybovostí pro 100 simulací zvlášť pro jednotlivé klasifikační metody. Černými symboly $+$ jsou vyznačeny průměry." width="672" />
<p class="caption">(\#fig:unnamed-chunk-117)Krabicové diagramy trénovacích chybovostí pro 100 simulací zvlášť pro jednotlivé klasifikační metody. Černými symboly $+$ jsou vyznačeny průměry.</p>
</div>
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-119-1.png" alt="Krabicové diagramy testovacích chybovostí pro 100 simulací zvlášť pro jednotlivé klasifikační metody. Černými symboly $+$ jsou vyznačeny průměry." width="672" />
<p class="caption">(\#fig:unnamed-chunk-119)Krabicové diagramy testovacích chybovostí pro 100 simulací zvlášť pro jednotlivé klasifikační metody. Černými symboly $+$ jsou vyznačeny průměry.</p>
</div>
...
Table: (\#tab:unnamed-chunk-121)Mediány hodnot hyperparametrů pro vybrané metody, u nichž se určoval nějaký hyperparametr pomocí cross-validace.
...
SVM_d_Poly                                             6.0
SVM_d_Radial                                           7.0
SVM_RKHS_radial_gamma1                                 0.0
SVM_RKHS_radial_gamma2                                 0.0
SVM_RKHS_radial_gamma3                                 0.0
SVM_RKHS_radial_d1                                     8.0
SVM_RKHS_radial_d2                                    11.0
SVM_RKHS_radial_d3                                    11.0
SVM_RKHS_poly_p1                                       3.0
SVM_RKHS_poly_p2                                       4.0
SVM_RKHS_poly_p3                                       2.0
SVM_RKHS_poly_d1                                       3.5
SVM_RKHS_poly_d2                                       4.0
SVM_RKHS_poly_d3                                       4.0
SVM_RKHS_linear_d1                                    19.0
SVM_RKHS_linear_d2                                    21.0
SVM_RKHS_linear_d3                                    16.0
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-122-1.png" alt="Histogramy hodnot hyperparametrů pro KNN, funkcionální logistickou regresi a také histogram pro počet hlavních komponent." width="672" />
<p class="caption">(\#fig:unnamed-chunk-122)Histogramy hodnot hyperparametrů pro KNN, funkcionální logistickou regresi a také histogram pro počet hlavních komponent.</p>
</div>
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-124-1.png" alt="Histogramy hodnot hyperparametrů metody SVM s projekcí na B-splinovou bázi." width="672" />
<p class="caption">(\#fig:unnamed-chunk-124)Histogramy hodnot hyperparametrů metody SVM s projekcí na B-splinovou bázi.</p>
</div>
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-126-1.png" alt="Histogramy hodnot hyperparametrů metody RKHS + SVM s radiálním jádrem." width="672" />
<p class="caption">(\#fig:unnamed-chunk-126)Histogramy hodnot hyperparametrů metody RKHS + SVM s radiálním jádrem.</p>
</div>
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-128-1.png" alt="Histogramy hodnot hyperparametrů metody RKHS + SVM s polynomiálním jádrem." width="672" />
<p class="caption">(\#fig:unnamed-chunk-128)Histogramy hodnot hyperparametrů metody RKHS + SVM s polynomiálním jádrem.</p>
</div>
...
<div class="figure">
<img src="09-Application_1_files/figure-html/unnamed-chunk-130-1.png" alt="Histogramy hodnot hyperparametrů metody RKHS + SVM s lineárním jádrem." width="672" />
<p class="caption">(\#fig:unnamed-chunk-130)Histogramy hodnot hyperparametrů metody RKHS + SVM s lineárním jádrem.</p>
</div>
