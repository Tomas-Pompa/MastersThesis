...
## 0.6429 0.6714 0.7429 0.7643 0.7000 0.7214 0.7071 0.7214 0.6857 0.7214 0.7357 
##     12 
## 0.7429 
## 
## -Optimal number of neighbors: knn.opt= 4 
## with highest probability of correct classification max.prob=  0.7642857 
## 
## -Probability of correct classification:  0.7643
```
...
```
##  [1] 0.6606803 0.6596633 0.7267955 0.7176985 0.6813964 0.7186327 0.6891803
##  [8] 0.7013060 0.7064348 0.7279549 0.7281497 0.7191271 0.7068977 0.7318255
## [15] 0.7284789 0.7215624 0.6852720 0.6819386 0.6491419 0.6460106 0.6305272
## [22] 0.6628672 0.6541901 0.6518342
```

Vidíme, že nejlépe vychází hodnota parametru $K$ jako 14 s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7318.
...
Vidíme tedy, že přesnost modelu sestrojeného pomocí metody $K$ nejbližších sousedů s optimální volbou $K_{optimal}$ rovnou 14, kterou jsme určili cross-validací, je na trénovacích datech rovna 0.25 a na testovacích datech 0.3333.
...
V tomto konkrétním případě jsme za počet hlavních komponent vzali $p$ = 2, které dohromady vysvětlují 99.81 % variability v datech.
První hlavní komponenta potom vysvětluje 98.94 % a druhá 0.87 % variability.
...
Spočítali jsme jednak přesnost klasifikátoru na trénovacích (78.57 %), tak i na testovacích datech (66.67 %).
...
Spočítali jsme tedy jednak přesnost klasifikátoru na trénovacích (78.57 %), tak i na testovacích datech (68.33 %).
...
Naopak optimální volbou na základě testovací chybovosti je $n$ rovno 24, tedy výrazně menší hodnota než 50.
...
```
##         4         5         6         7         8         9        10        11 
## 0.7675165 0.7657065 0.7763995 0.7428249 0.7369425 0.7569425 0.7569425 0.7239871 
##        12        13        14        15        16        17        18        19 
## 0.7203957 0.7060417 0.7262781 0.7084659 0.7312729 0.7246063 0.7155154 0.7098694 
##        20        21        22        23        24        25 
## 0.6962948 0.7039871 0.7110316 0.7032028 0.6538468 0.6703988
```

Vykresleme si ještě průběh validační chybovosti i se zvýrazněnou optimální hodnotou $n_{optimal}$ rovnou 6 s validační chybovostí 0.2236.
...
Spočítali jsme trénovací chybovost (rovna 21.43 %) i testovací chybovost (rovna 25 %).
...
Spočítali jsme tedy přesnost klasifikátoru na trénovacích (78.57 %) i na testovacích datech (70 %).
...
Přesnost klasifikátoru na testovacích datech je tedy 61.67 % a na trénovacích datech 73.57 %.
...
Přesnost rozhodovacího stromu na testovacích datech je tedy 70 % a na trénovacích datech 79.29 %.
...
Přesnost rozhodovacího stromu na trénovacích datech je tedy 73.57 % a na testovacích datech 61.67 %.
...
Přesnost náhodného lesu na trénovacích datech je tedy 95 % a na testovacích datech 66.67 %.
...
Přesnost rozhodovacího stromu na trénovacích datech je tedy 95 % a na testovacích datech 66.67 %.
...
Přesnost tohoto klasifikátoru na trénovacích datech je 95 % a na testovacích datech 65 %.
...
Přesnost metody SVM na trénovacích datech je tedy 82.14 % pro lineární jádro, 52.86 % pro polynomiální jádro a 77.86 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 73.33 % pro lineární jádro, 56.67 % pro polynomiální jádro a 66.67 % pro radiální jádro.
...
Přesnost metody SVM aplikované na skóre hlavních komponent na trénovacích datech je tedy 80 % pro lineární jádro, 75 % pro polynomiální jádro a 78.57 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 70 % pro lineární jádro, 68.33 % pro polynomiální jádro a 68.33 % pro radiální jádro.
...
Přesnost metody SVM aplikované na bázové koeficienty na trénovacích datech je tedy 81.43 % pro lineární jádro, 53.57 % pro polynomiální jádro a 78.57 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 71.67 % pro lineární jádro, 58.33 % pro polynomiální jádro a 66.67 % pro radiální jádro.
...
Vidíme, že nejlépe vychází hodnota parametru $d$ jako 5 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7857, 4 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6352 a 5 pro radiální jádro s hodnotou přesnosti 0.7408.
...
Přesnost metody SVM aplikované na bázové koeficienty na trénovacích datech je tedy 19.29 % pro lineární jádro, 32.14 % pro polynomiální jádro a 17.14 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 28.33 % pro lineární jádro, 31.67 % pro polynomiální jádro a 28.33 % pro radiální jádro.
...
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS                                                                    0.2143                                                   0.4167
SVM poly - RKHS                                                                      0.2143                                                   0.4000
SVM rbf - RKHS                                                                       0.1714                                                   0.3333
...
-------  ------------------------------  ----------------------------------  ----------------------------------  ----------------------------------
linear                               11                              0.0164                              0.2887  linear                            
poly                                  5                              0.0100                              0.2764  polynomial                        
radial                                6                              0.0100                              0.2898  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 11 a $\gamma={}$ 0.0164 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7113, $d={}$ 5 a $\gamma={}$ 0.01 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.7236 a $d={}$ 6 a $\gamma={}$ 0.01 pro radiální jádro s hodnotou přesnosti 0.7102.
...
Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - radial                                                           0.2857                                                   0.3167
SVM poly - RKHS - radial                                                             0.2786                                                   0.3500
SVM rbf - RKHS - radial                                                              0.2857                                                   0.3333

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 28.57 % pro lineární jádro, 27.86 % pro polynomiální jádro a 28.57 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 31.67 % pro lineární jádro, 35 % pro polynomiální jádro a 33.33 % pro radiální jádro.
...
-------  ------------------------------  ------------------------------  ----------------------------------  ----------------------------------
linear                                9                               3                              0.3132  linear                            
poly                                 10                               4                              0.3399  polynomial                        
radial                                6                               3                              0.3132  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 9 a $p={}$ 3 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6868, $d={}$ 10 a $p={}$ 4 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6601 a $d={}$ 6 a $p={}$ 3 pro radiální jádro s hodnotou přesnosti 0.6868.
...
Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - poly                                                             0.3143                                                   0.3000
SVM poly - RKHS - poly                                                               0.4571                                                   0.5000
SVM rbf - RKHS - poly                                                                0.3071                                                   0.3167

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 31.43 % pro lineární jádro, 45.71 % pro polynomiální jádro a 30.71 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 30 % pro lineární jádro, 50 % pro polynomiální jádro a 31.67 % pro radiální jádro.
...
-------  ------------------------------  ----------------------------------  ----------------------------------
linear                                7                              0.3336  linear                            
poly                                  7                              0.3527  polynomial                        
radial                               13                              0.3182  radial                            

Vidíme, že nejlépe vychází hodnota parametru $d={}$ 7 pro lineární jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6664, $d={}$ 7 pro polynomiální jádro s hodnotou přesnosti spočtenou pomocí 10-násobné CV 0.6473 a $d={}$ 13 pro radiální jádro s hodnotou přesnosti 0.6818.
...
Model                                $\widehat{Err}_{train}\quad\quad\quad\quad\quad$         $\widehat{Err}_{test}\quad\quad\quad\quad\quad$       
----------------------------------  -------------------------------------------------------  -------------------------------------------------------
SVM linear - RKHS - linear                                                           0.3357                                                   0.2833
SVM poly - RKHS - linear                                                             0.3214                                                   0.2833
SVM rbf - RKHS - linear                                                              0.3143                                                   0.3167

Přesnost metody SVM v kombinaci s projekcí na Reproducing Kernel Hilbert Space je tedy na trénovacích datech rovna 33.57 % pro lineární jádro, 32.14 % pro polynomiální jádro a 31.43 % pro gaussovské jádro.
Na testovacích datech je potom přesnost metody 28.33 % pro lineární jádro, 28.33 % pro polynomiální jádro a 31.67 % pro radiální jádro.
...
LDA                                                                                  0.2143                                                   0.3333
QDA                                                                                  0.2143                                                   0.3167
LR functional                                                                        0.2143                                                   0.2500
LR score                                                                             0.2143                                                   0.3000
Tree - diskr.                                                                        0.2643                                                   0.3833
Tree - score                                                                         0.2071                                                   0.3000
Tree - Bbasis                                                                        0.2643                                                   0.3833
RForest - diskr                                                                      0.0500                                                   0.3333
RForest - score                                                                      0.0500                                                   0.3333
RForest - Bbasis                                                                     0.0500                                                   0.3500
SVM linear - diskr                                                                   0.1786                                                   0.2667
SVM poly - diskr                                                                     0.4714                                                   0.4333
SVM rbf - diskr                                                                      0.2214                                                   0.3333
SVM linear - PCA                                                                     0.2000                                                   0.3000
SVM poly - PCA                                                                       0.2500                                                   0.3167
SVM rbf - PCA                                                                        0.2143                                                   0.3167
SVM linear - Bbasis                                                                  0.1857                                                   0.2833
SVM poly - Bbasis                                                                    0.4643                                                   0.4167
SVM rbf - Bbasis                                                                     0.2143                                                   0.3333
SVM linear - projection                                                              0.1929                                                   0.2833
SVM poly - projection                                                                0.3214                                                   0.3167
SVM rbf - projection                                                                 0.1714                                                   0.2833
SVM linear - RKHS - radial                                                           0.2857                                                   0.3167
SVM poly - RKHS - radial                                                             0.2786                                                   0.3500
SVM rbf - RKHS - radial                                                              0.2857                                                   0.3333
SVM linear - RKHS - poly                                                             0.3143                                                   0.3000
