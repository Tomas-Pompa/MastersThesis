...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-3-1.png" alt="Vykreslení prvních 100 vyhlazených pozorovaných křivek. Černou čarou je zakreslen průměr." width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-5-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-6-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-6-2.png" width="672" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-9-1.png" alt="B-spliny." width="1152" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-11-1.png" alt="B-spliny." width="1152" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-13-1.png" alt="Fourierova baze." width="1152" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-15-1.png" alt="Fourierova baze." width="1152" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-16-1.png" alt="B-spliny." width="1152" />
<p class="caption">(\#fig:unnamed-chunk-16)B-spliny.</p>
</div>

```r
# dev.off()
# ggsave('figures/DP_kap2_differentnbasis.tex', width = 12, height = 4, device = tikz)
```
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-19-1.png" alt="Log-periodogram vybraného fonému pro zvolené hodnoty vyhlazovacího parametru." width="864" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-21-1.png" alt="Log-periodogram vybraného fonému pro zvolené hodnoty vyhlazovacího parametru." width="864" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-26-1.png" alt="Hodnoty skórů prvních tří hlavních komponent pro trénovací data. Barevně jsou odlišeny body podle příslušnosti do klasifikační třídy." width="1152" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-28-1.png" alt="Kumulativní vysvětlená variabilita [v %] proti po4tu hlavn9ch komponent." width="576" />
<p class="caption">(\#fig:unnamed-chunk-28)Kumulativní vysvětlená variabilita [v %] proti po4tu hlavn9ch komponent.</p>
</div>
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-29-1.png" alt="Hlavní komponenty." width="576" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-30-1.png" alt="Vliv komponent." width="1152" />
...
p0 <- ggplot(data = df, aes (x = time, y = value)) +
  ...
  labs(x = "Frekvence [v Hz]", y = "Log-periodogram") +
  theme_bw()
print(p0)
```

<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-31-1.png" alt="Původní křivka a průměr." width="576" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-32-1.png" alt="Původní křivka a její rekonstrukce." width="864" />
...
Tyto materiály jsou převzaty z Kapitoly Aplikace na reálných datech 2. 
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-34-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-36-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-37-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-39-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-41-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-42-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-43-1.png" width="672" />
...
<img src="13-Application_5_files/figure-html/unnamed-chunk-44-1.png" width="672" />
...
```
##  [1] "large" "large" "large" "small" "small" "small" "small" "small" "small"
## [10] "small"
```
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-55-1.png" alt="Vykreslení prvních 100 vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Černou čarou je zakreslen průměr pro každou třídu." width="672" />
<p class="caption">(\#fig:unnamed-chunk-55)Vykreslení prvních 100 vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Černou čarou je zakreslen průměr pro každou třídu.</p>
</div>
...
```
##  [1] ao ao ao ao ao ao ao ao ao ao
## Levels: aa ao
```
...
```
##  [1] ao aa aa aa aa ao aa aa aa aa
## Levels: aa ao
```
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-59-1.png" alt="Vykreslení prvních 100 vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Černou čarou je zakreslen průměr pro každou třídu." width="672" />
<p class="caption">(\#fig:unnamed-chunk-59)Vykreslení prvních 100 vyhlazených pozorovaných křivek, barevně jsou odlišeny křivky podle příslušnosti do klasifikační třídy. Černou čarou je zakreslen průměr pro každou třídu.</p>
</div>
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-62-1.png" alt="Porovnání pozorované a odhadnuté křivky." width="672" />
...
<div class="figure">
<img src="13-Application_5_files/figure-html/unnamed-chunk-66-1.png" alt="Porovnání pozorované a odhadnuté křivky." width="672" />
