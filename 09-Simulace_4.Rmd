...
```{r, echo=FALSE}
load('RData/simulace_04.RData', verbose = F)
load('RData/simulace_04_res.RData', verbose = F)
```
...
# Simulace na základě druhé derivace
...
# ulozime vysledne hodnoty 
save(SIMULACE, CV_RESULTS, file = 'RData/simulace_04_2der.RData')
```
...
# ulozime vysledne hodnoty 
save(SIMULACE.df, file = 'RData/simulace_04_res_2der.RData')
```

### Výsledky

```{r, echo=FALSE}
load('RData/simulace_04_2der.RData', verbose = F)
load('RData/simulace_04_res_2der.RData', verbose = F)
```
