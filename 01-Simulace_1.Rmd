...
S touto optimální volbou vyhlazovacího parametru $\lambda =$ `r lambda.opt` nyní vyhladíme všechny funkce a opět znázorníme graficky prvních 10 pozorovaných křivek z každé klasifikační třídy.
...
```{r, echo=FALSE}
load('RData/simulace_01.RData', verbose = F)
load('RData/simulace_01_res.RData', verbose = F)
```
...
```{r echo=FALSE, eval=T}
ggsave('figures/sim_01_boxplot_train.pdf', width = 10, height = 6)
```
...
```{r echo=FALSE, eval=T}
ggsave('figures/sim_01_boxplot_test.pdf', width = 10, height = 6)
```
...
```{r echo=FALSE, eval=T}
ggsave('figures/sim_01_histogram_hyperparams_0.pdf', width = 10, height = 6)
```
...
```{r echo=FALSE, eval=T}
ggsave('figures/sim_01_histogram_hyperparams_1.pdf', width = 10, height = 6)
```
...
```{r echo=FALSE, eval=T}
ggsave('figures/sim_01_histogram_hyperparams_2.pdf', width = 10, height = 6)
```
...
```{r echo=FALSE, eval=T}
ggsave('figures/sim_01_histogram_hyperparams_3.pdf', width = 10, height = 6)
```
...
```{r echo=FALSE, eval=T}
ggsave('figures/sim_01_histogram_hyperparams_4.pdf', width = 10, height = 6)
```
